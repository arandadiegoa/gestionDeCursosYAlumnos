        ...
        <form action="{{ route('cursos.store') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" name="aula_virtual" id="aula_virtual" value="{{ old('aula_virtual') }}"
            ...
            <div style="display: flex; align-items:flex-end; gap:10px">
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary w-10">Guardar Curso</button>
                </div>
